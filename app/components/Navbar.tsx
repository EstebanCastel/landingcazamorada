      ...
      <div className="container">
        <div className="navbar__inner">
          <a href="#" className="navbar__logo">
            <div className="navbar__logo-icon">CM</div>
            <div className="navbar__logo-text">CazaMorada</div>
          </a>
          ...
          <a href="#membresia" className="navbar__cta">
            Aplica ahora
        ...
        <div className={`navbar__mobile ${menuOpen ? "open" : ""}`}>
          ...
          <a href="#membresia" onClick={() => setMenuOpen(false)} className="navbar__mobile-cta">
            Aplica ahora
          </a>
        </div>
      </div>
